        ...
        <form method="POST" action="{{ route('courses.update', $course) }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input class="form-control" type="number" name="credits" value="{{ old('credits', $course->credits) }}" required>
                </div>
                <div class="col-md-3">
                    <label class="form-label">Level</label>
                    <input class="form-control" name="level" value="{{ old('level', $course->level) }}">
                </div>
                <div class="col-12">
